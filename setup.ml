...
(* OASIS_START *)
(* DO NOT EDIT (digest: adcda4aef5f5aba62db20e4a7b8defd3) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/ergl/ads-ml/";
          synopsis = "ADS - Authenticated Data Structures for OCaml";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "%\015¦\003\t=\158¶Ú¦\nü\158Ä\030\015";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
